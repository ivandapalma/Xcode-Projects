...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // Color de fondeo en barra de navegación
        UINavigationBar.appearance().barTintColor = #colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1)
        UINavigationBar.appearance().tintColor = UIColor.white // Color de navegación hacia atrás
        
        // Cambiar fuente y color del texto de la barra principal
